...
aliens, bullets, mouse_x, mouse_y):
    ...
    if button_clicked and not stats.game_active:
        ...
        #Usunęcie zawartości list aliens i bullets.
        aliens.empty()
        bullets.empty()
...
aliens, bullets):
    """Reakcja na kolizję miedzy pociskiem i obcym."""
    #Usunięcie wszystkich pocisków i obcych, miedzy którymi doszło do kolizji.
    ...
    if len(aliens) == 0:
        #Jeśli caałqaa folta została zniszczona, gracz przechodzi na kolejny poziom.
        bullets.empty()
...
def get_numbers_aliens_x(ai_settings, alien_width):
    """Ustalanie liczby obcych, którzy się zmieszczą w rzędzie"""
...
def create_fleet(ai_settings, screen, ship, aliens):
    ...
    #Utworzenie obcego i ustalenie liczby obcych, którzy zmieszczą
    #  się w rzędzie.
    alien = Alien(ai_settings, screen)
    number_aliens_x = get_numbers_aliens_x(ai_settings,
    alien.rect.width)
    number_rows = get_numbers_rows(ai_settings, ship.rect.height,
    alien.rect.height)
    
    #Utowrzenie floty obcych.
...
def get_numbers_rows(ai_settings, ship_height, alien_height):
    """Ustalanie, ile rtzędów obcych zmieści się na ekranie."""
...
def check_aliens_bottom(ai_settings, screen, stats, sb, ship, aliens, bullets):
    """Sprawdzanie, czy którykolwiek obcy dotarł do dolnej krawędzi
    ekranu."""
...
def update_aliens(ai_settings, screen, stats, sb, ship, aliens, bullets):
    """Sprawdzenie czy flota znajdue się przy kraawędzi ekranu,
